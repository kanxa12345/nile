...
import SkilledData from './SkilledData';
        ...
        <>
            <section className='py-20 relative'>
                ...
                <div className="container py-12 relative z-20 mt-10" data-aos="zoom-in" data-aos-duration="1000" data-aos-once='true'>
                    <h1 className='md:text-6xl sm:text-4xl text-3xl font-extrabold text-center text-white'><big className='text-yellow-300'>Skilled</big> Category</h1>
                </div>
            </section>
