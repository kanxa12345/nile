    ...
    return (
        <section className='py-12'>
            <div className="container grid md:grid-cols-2 grid-cols-1 gap-4">
                <div className='shadow-[0_0_20px_2px_rgba(0,0,0,0.2)] p-5 rounded-xl md:mb-0 mb-6' data-aos="fade-right" data-aos-duration="1000" data-aos-once='true' data-aos-delay='200'>
                    <h2 className='md:text-2xl text-xl font-semibold mb-4'>ENQUIRE WITH US</h2>
                    <form>
                ...
                <div>
                    <div className='mb-6' data-aos="fade-left" data-aos-duration="1000" data-aos-once='true' data-aos-delay='200'>
