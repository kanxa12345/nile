        ...
        <>
            <section className='py-20 relative'>
                ...
                <div className="container py-12 relative z-20 mt-10">
                    <h1 className='text-6xl font-extrabold text-center text-white'><big className='text-yellow-300'>New</big> Vacancy</h1>
                </div>
            </section>
            <section className='py-12'>
                <div className='container flex flex-col items-center'>
                    <h2 className='text-4xl font-bold pb-2 mb-8 relative pseudo-border'>New Vacancy Available</h2>
