            ...
            <div className="bg-gray-100">
                <div className="pb-6 pt-8 container grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-3 md:gap-8 gap-4">
                    ...
                    <div className="sm:mb-4 mb-10">
                        <img className="md:w-full sm:w-2/3 w-full" src={logo} alt="logo" />
                        <div className="mt-10">
                    ...
                    <div className="flex lg:justify-center justify-start sm:mb-4 mb-10">
                        <div>
                            ...
                            <div className="flex justify-between items-center mt-5">
                                <a href="https://www.facebook.com/Nileintl" target="_blank" rel="noreferrer"><i className="fa fa-facebook text-2xl text-blue-600"></i></a>
